...
public class Date {
  ...
  public /* NO RETURN TYPE!!! */ Date(int day, int month, int year) {
    ...
    || month < 1 || month > 12) throw new IllegalArgumentException("Bad date values");
    this.day = day;
    this.month = month;
    this.year = year;
  }
...
//  public /*static*/ String asText(Date this) {
  public /*static*/ String asText() { // "this" is IMPLICIT HERE
...
//    d.month = 9;
//    d.year = 2023;
    // new creates the storage, "constructor" simply initializes that object
//    Date d = new Date(12, 19, 2023); // exception :)
    Date d = new Date(12, 9, 2023);
    System.out.println("date is " + d);
//    System.out.println("date is " + /*classstuff.*/Date.asText(d));
    System.out.println("date is " + /*classstuff.*/d.asText());
